...
class KnockThreeController: UIViewController {

    private var currentChildViewController: UIViewController?
    private var secondViewController: KnockFourController?
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        secondViewController = instantiate(id: "KnockFour")
    }
