...
class KnockFiveController: UIViewController {

    private var currentChildViewController: UIViewController?
    private var secondViewController: KnockOneController?
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        secondViewController = instantiate(id: "KnockOne")
    }
